...
When I inherited the program, leadership treated CT as a service function. A partner wanted to sell their business. We processed the request and measured success by speed and satisfaction. Under that framing, an 89% rejection rate and 16-week average against a 7-week SLA are indefensible.
...
Decision time dropped from 16.98 weeks to 2.28 weeks on average—an 86.6% reduction—not because I lowered the bar, but because the stage gates caught unqualified candidates in days instead of months. The longest case in 2023—at 8.71 weeks—was still faster than the old average. By December, requests closed in under a week.

29 successful transfers at $482K+ each in avoided exit costs—$13M the network kept, and 29 routes that held capacity. Approved candidates performed 18 percentage points above the network average in partner quality scores.

Annual case volume grew from 5 cases in 2020 to 87 in 2024, with zero backlog. The SOP became the foundation for the 2025 Legacy Transfer strategy—a leadership initiative targeting $25M in avoided exit costs by 2026. I owned end-to-end implementation.
