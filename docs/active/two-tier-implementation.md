...
**For each case study (in this order):**

**A. Contract Transfer** (start here — most edits already made, straightforward guide)
...
Anonymization guide: `work/pinnacle-program-selection/anonymization-guide.md`

**Then for each public version:**

1. Apply all Tier 1 replacements from the case study's anonymization guide

2. Update these HTML elements in the public version:
...
3. Add a CTA section before the lessons, linking to the protected version:
...
| 5a   | Apply anonymization: **Contract Transfer** — `work/contract-transfer/anonymization-guide.md`             | Local repo    | 15 min |
| 5b   | Apply anonymization: **Partner Application** — `work/cfa-dsp-application/anonymization-guide.md`         | Local repo    | 20 min |
| 5c   | Apply anonymization: **Selection Automation** — `work/pinnacle-program-selection/anonymization-guide.md` | Local repo    | 10 min |
