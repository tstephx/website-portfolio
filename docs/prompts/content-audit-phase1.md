...
Then read the three anonymization guides (these define what differs between tiers): 4. `work/contract-transfer/anonymization-guide.md` 5. `work/cfa-dsp-application/DSP-anonymization-guide.md` 6. `work/pinnacle-program-selection/anonymization-guide.md`

Also read the Phase 0 mechanical results: 7. `docs/active/audit-phase0-results.txt` — automated checks already completed
